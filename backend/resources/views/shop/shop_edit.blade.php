    ...
    <form action="{{ route('shop.update',  $data->id ) }}" method="POST" enctype="multipart/form-data">
      @method('put')
        ...
        <div class="mb-2">
          ...
          <input type="text" class="form-control" name="shop_phone" value="{{ $data->shop_phone }}">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Shop Location</label>
          <input type="text" class="form-control" name="shop_location" value="{{ $data->shop_location }}">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Shop longitude</label>
          <input type="text" class="form-control" name="address_longitude" value="{{ $data->address_longitude }}">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Shop latitude</label>
          <input type="text" class="form-control" name="address_latitude" value="{{ $data->address_latitude }}">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Shop Photo</label>
          <img src="/{{ $data->shop_img }}" alt="" height="150px" width="200px">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Shop Photo</label>
