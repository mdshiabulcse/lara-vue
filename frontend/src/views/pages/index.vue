      ...
      <div class="row">
        <div class="col-lg-12 order-0 order-lg-1 order-xl-1">
          <div class="home-grid-slider slider-arrow slider-dots">
            <a href="#"><img src="@/images/banner/01.jfif" alt="" /></a
            ><a href="#"><img src="@/images/banner/02.jfif" alt="" /></a>
            <a href="#"><img src="@/images/banner/03.jfif" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
            ...
            <ul>
              <li>
                <a class="suggest-card" href="shop-4column.html">
                  <img src="@/images/promo/home/07.jpg" alt="" />
                </a>
              </li>
            </ul>
        ...
        <div class="col">
          <div class="product-card">
            <ul>
              <li>
                <a class="suggest-card" href="shop-4column.html">
                  <img src="@/images/promo/home/06.jpg" alt="" />
                </a>
              </li>
            </ul>
